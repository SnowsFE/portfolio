(this.webpackJsonpportfolio=this.webpackJsonpportfolio||[]).push([[0],{21:function(e,t){},26:function(e,t,i){},38:function(e,t,i){"use strict";i.r(t);var o=i(1),a=i.n(o),n=i(17),s=i.n(n),c=(i(26),i(8)),l=i(3),r=i(2),p=i(0);var d=e=>{if("1"===e.level)return Object(p.jsx)("h1",{...e,children:e.children});switch(e.level){case"1":default:return Object(p.jsx)("h1",{...e,children:e.children});case"2":return Object(p.jsx)("h2",{...e,children:e.children});case"3":return Object(p.jsx)("h3",{...e,children:e.children});case"4":return Object(p.jsx)("h4",{...e,children:e.children})}};const m=r.b.div`
	position: relative;
...
`;var K=D;var Y=function(){const e=[].slice.call(document.querySelectorAll("li"),0),t={0:"top",1:"right",2:"bottom",3:"left"},i=["in","out"].map((e=>Object.values(t).map((t=>`${e}-${t}`)))).reduce(((e,t)=>e.concat(t)));class o{constructor(e){this.element=e,this.element.addEventListener("mouseover",(e=>this.update(e,"in"))),this.element.addEventListener("mouseout",(e=>this.update(e,"out")))}update(e,o){this.element.classList.remove(...i),this.element.classList.add(`${o}-${t[((e,t)=>{const{width:i,height:o,top:a,left:n}=t.getBoundingClientRect(),s=e.pageX-(n+window.pageXOffset)-i/2*(i>o?o/i:1),c=e.pageY-(a+window.pageYOffset)-o/2*(o>i?i/o:1);return Math.round(Math.atan2(c,s)/1.57079633+5)%4})(e,this.element)]}`)}}return e.forEach((e=>new o(e))),Object(p.jsx)(X,{})};const X=r.b.div`
  max-width: 1140px;
  margin: auto;
  padding-bottom: 80px;
  h2 {
...
`;class q extends o.Component{render(){return Object(p.jsx)(y,{page:"projects",children:Object(p.jsxs)("main",{children:[Object(p.jsxs)(h,{titleBg:"Works",children:["My ",Object(p.jsx)("span",{className:"point",children:"Projects"})]}),Object(p.jsxs)("section",{children:[Object(p.jsx)(K,{}),Object(p.jsx)(Y,{})]})]})})}}var Q=q;i(21);o.Component;const V=r.b.div`
  max-width: 800px;
  margin: 0 auto;
  .tit-wrap {
    .meta-data {
